...
const RightMenu = ({ visible, position, onClose, onAdd, onEdit, onDelete, onToggleVisible, isHidden }: RightMenuProps) => {
  ...
  return (
    <div ref={menuRef} className={cn(styles.rightMenu, { [styles.show]: visible })} style={{ left: `${position.x}px`, top: `${position.y}px` }}>
