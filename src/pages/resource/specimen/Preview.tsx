...
export default function Preview(props: ModalProp.OperateModalProp<Api.ResourceManage.Specimen>) {
  const [, setAction] = useState<ModalProp.OperateAction>('create');
  const [visible, setVisible] = useState(false);
  const [record, setRecord] = useState<Api.ResourceManage.Specimen | null>(null); // 存储当前预览数据
  ...
  return (
    <Modal
      ...
      width={isFullScreen ? '100vw' : 1400} // 全屏时宽度 100vw，否则 1400px
