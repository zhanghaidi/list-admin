...
export default function Preview(props: ModalProp.OperateModalProp<Api.ResourceManage.Sport>) {
  const [, setAction] = useState<ModalProp.OperateAction>('create');
  const [visible, setVisible] = useState(false);
  const [record, setRecord] = useState<Api.ResourceManage.Sport | null>(null); // 存储当前预览数据
